...
if [[ -f ~/.zplug/init.zsh ]] {
	...
	zplug "dylanaraps/neofetch", as:command, from:gh-r, hook-build:"make PREFIX=/usr/local install"
	...
	zplug "plugins/colored-man-pags", from:oh-my-zsh
	zplug "plugins/sudo", from:oh-my-zsh
	zplug "plugins/history-substring-search", from:oh-my-zsh

	# macOS
	zplug "rcmdnk/open_newtab", as:command, use:"bin/open_newtab", rename-to:otab, if:"[[ $OSTYPE == *darwin* ]]"
...
source ~/.config/zsh/plugins_set.zsh
